...
describe('Space Entities', () => {
  ...
  it(
    'The entity fetch complete callback is called',
    async () => {
      // Create a test user and log in
      using userProfile = await makeTestUser(userSystem);
  ...
  it(
    'The remote entity created callback is called',
    async () => {
      // Create a test user and log in
      using userProfile = await makeTestUser(userSystem);
  ...
  it(
    'The entity update callback is called for entity updates',
    async () => {
      // Create a test user and log in
      using userProfile = await makeTestUser(userSystem);
  ...
  it(
    'The entity update callback is called for component updates',
    async () => {
      // Create a test user and log in
      using userProfile = await makeTestUser(userSystem);
