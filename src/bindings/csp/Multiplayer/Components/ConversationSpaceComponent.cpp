...
EMSCRIPTEN_BINDINGS(CSPConversationSpaceComponent)
{
    emscripten::enum_<csp::multiplayer::ConversationPropertyKeys>("ConversationPropertyKeys", emscripten::enum_value_type::number)
        ...
        .value("Date_DEPRECATED", csp::multiplayer::ConversationPropertyKeys::Date_DEPRECATED)
        .value("NumberOfReplies_DEPRECATED", csp::multiplayer::ConversationPropertyKeys::NumberOfReplies_DEPRECATED)
