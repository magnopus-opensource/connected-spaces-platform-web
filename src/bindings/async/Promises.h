...
/*
 * Utility for converting a C++ function that takes a callback into a function that returns a JavaScript Promise.
 *
 ...
 *     {
 *       return PromisifyWithClone<int, PromiseNumberValType>(
 ...
 *    used prior to this binding code. See the Callbacks.h for more details.
 ...
 *
 * CallbackArgT: Callback function argument type. Only one argument is supported currently.
